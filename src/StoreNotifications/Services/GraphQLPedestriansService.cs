...
{
    public class GraphQLPedestriansService
    {
        ...
        private readonly PedestrianObserver _observer;
        private GraphQLHttpClient _graphQlClient;

        private IDisposable _subscription;

        public GraphQLPedestriansService(
            ILogger logger,
            string schema,
            string host,
            int port,
            string path,
            PedestrianObserver observer
        )
        {
  ...
  pedestrianProcessed {
    ...
    pedestrianInformation {
      ...
      pedestriansOnFrameCount
            ...
            var _subscriptionStream = _graphQlClient.CreateSubscriptionStream<PedestrianProcessedResponse>(
                _graphQLRequest,
                ex =>
                {
