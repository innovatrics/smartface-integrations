...
- run following commands
 - `docker build -f src/DataCollection/Dockerfile -t registry.gitlab.com/innovatrics/smartface/integrations-data-collection:0.2.12 .`
 - `docker tag registry.gitlab.com/innovatrics/smartface/integrations-data-collection:0.2.12 registry.gitlab.com/innovatrics/smartface/integrations-data-collection:latest`
 - `docker push registry.gitlab.com/innovatrics/smartface/integrations-data-collection:0.2.12`
...
```
  ...
  data-collection:
    image: ${REGISTRY}integrations-data-collection
    restart: unless-stopped
    environment:
