...
namespace Innovatrics.SmartFace.Integrations.FaceGate
{
    ...
    {
        public const string LOG_FILE_NAME = "SmartFace.Integrations.FaceGate.log";
        ...
        private static ILogger ConfigureLogger(string[] args, IConfiguration configuration)
        {
            ...
            var logDir = Path.Combine(Path.Combine(commonAppDataDirPath, "Innovatrics", "SmartFace2FaceGate"));
        ...
        private static IServiceCollection ConfigureServices(IServiceCollection services, ILogger logger)
        {
            ...
            services.AddSingleton<IFaceGateAdapter, FaceGateAdapter>();
        ...
        private static IConfigurationRoot ConfigureBuilder(string[] args)
        {
            return new ConfigurationBuilder()
                    ...
                    .AddEnvironmentVariables($"SF_INT_FACEGATE_")
                    .AddCommandLine(args)
                    .Build();
        }
