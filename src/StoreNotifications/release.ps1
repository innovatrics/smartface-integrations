...
$repository = "registry.gitlab.com/innovatrics/smartface/integrations-store-notifications"

# Build the Docker image
Write-Host "Building Docker image with tag $version..."
docker build -f src/StoreNotifications/Dockerfile -t "$repository`:$version" .
