...
$repository = "registry.gitlab.com/innovatrics/smartface/integrations-access-control-connector"

# Build the Docker image
Write-Host "Building Docker image with tag $version..."
docker build -f src/AccessControlConnector/Dockerfile -t "$repository`:$version" .
